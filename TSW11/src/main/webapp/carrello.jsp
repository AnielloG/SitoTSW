...
.right-column td {
  color: #FEFAF6; /* Product text color */
}
...
input[type="submit"]:hover {
  background-color: #102C57; /* Change to blue */
  border-radius: 14px;
}

/* Button styles for "Rimuovi" and "Svuota Carrello" */
a[href*="svuotaC"],
a[href*="DeleteC"] {
  background-color: #e5b80b; /* Lighter button color for contrast */
  color: #ffffff;
  padding: 10px;
...
a[href*="svuotaC"]:hover,
a[href*="DeleteC"]:hover {
  background-color: #DAC0A3; /* Slightly brighter color on hover */
}

/* Adjust total price color */
.total-price h3 {
  color: #fff;
  font-size: 18px;
}
...
<div class="left-column">
    <div class="logo-container">
        <a href="Home.jsp"><img src="assets/images/nuovologo.png" width="130px" alt="#"></a>
    </div>
<form action="acquista" method="post">
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                3G Vintage <br> Via Armando Diaz 176 San Giuseppe Ves.
            </td>
        </tr>
    </table>
